        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.fullName}</span>
                <img class="img-profile rounded-circle"
                     src="<c:url value="/template/admin/img/undraw_profile.svg"/>" alt="...">
            </a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<c:url value="/dang-xuat?action=logout"/>">Xác nhận</a>
            </div>
        </div>
    </div>
</div>